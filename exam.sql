...
insert  into `answerpaper`(`pnums`,`Sno`,`Cno`,`Qno`,`APanswer`,`APscore`,`APstate`,`scscore`,`mcscore`,`jscore`,`pname`) values (1,'2014010','501','7/9','121@',0,'待批阅',4,8,4,'ly测试试卷');
...
insert  into `teacher`(`Tno`,`Tname`,`Tsex`,`Tpassword`) values ('a01','黄林森0','女','123'),('b01','admin','男','123'),('c01','潘铁民','女','789'),('teacher','测试教师','男','888');
...
insert  into `teaching`(`Tno`,`Cno`,`Tsdept`,`Tclass`) values ('a01','501','商业智能1班','203'),('c01','503','语言艺术1班','203'),('c01','504','不知道','011'),('b01','501','商业智能1班','203'),('teacher','501','测试','010/'),('teacher','502','测试','010/'),('teacher','503','测试','010/'),('teacher','504','测试','010/');
