...
<body class="fixed-sidebar full-height-layout gray-bg"
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						...
						<div class="logo-element">教师管理</div>
					</li>
					<li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
						<span class="ng-scope">总览</span>
					</li>
					<li><a class="J_menuItem"
						href="${pageContext.request.contextPath }/teacher/info.jsp"> <i
							class="fa fa-home"></i> <span class="nav-label">个人中心</span> </a>
					</li>
					...
					<li><a href="#"> <i class="fa fa fa-bar-chart-o"></i> <span
						...
						<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/teacherAction?action=paperListShow">试卷列表</a>
							</li>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/teacherAction?action=CreatePapers01">创建试卷</a>
							</li>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/teacherAction?action=DreadPapers">批阅试卷</a>
							</li>
                    ...
                    <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                     ...
                     <li><a class="J_menuItem" href="${pageContext.request.contextPath }/teacher/studentinfo.jsp">学生部</a>
                            </li>
  ...
  <li class="line dk"></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                           <c:forEach items="${course}" var="course">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath }/teacherAction?action=questionList&courses=${course.cno}">${course.cname}题库</a>
                            </li>
				...
				<li><a class="J_menuItem"
					...
					<%-- <li><a class="J_menuItem"
					href="${pageContext.request.contextPath }/	teacher/grade.jsp"><i></i>
						<span>成绩查询入口</span> </a>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<!--
                	...
                	描述：框架内容嵌套开始
                -->
				<iframe id="J_iframe" name="main" width="100%" height="100%"
					src="${pageContext.request.contextPath}/teacher/info.jsp"
...
-->
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/jquery.min.js"
		type="text/javascript"></script>

	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/pageloader.js"
		type="text/javascript"></script>
	...
	<script>
		...
		function resizenow() {
			...
			jQuery('.bonfire-pageloader-icon')
					.css(
							'right',
							((browserwidth - jQuery(".bonfire-pageloader-icon")
									.width()) / 2))
					.css(
							'top',
							((browserheight - jQuery(".bonfire-pageloader-icon")
									.height()) / 2));
		};
		resizenow();
	</script>
	...
	<!-- 全局js -->
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/jquery.min.js?v=2.1.4"></script>
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/bootstrap.min.js?v=3.3.6"></script>
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/plugins/metisMenu/jquery.metisMenu.js"></script>
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/plugins/layer/layer.min.js"></script>

	<!-- 自定义js -->
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/hAdmin.js?v=4.1.0"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/teacher/Reception/js/index.js"></script>

	<!-- 第三方插件 -->
	<script
		src="${pageContext.request.contextPath}/teacher/Reception/js/plugins/pace/pace.min.js"></script>
