...
<body class="gray-bg">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-8">
            ...
            <div class="row"> <a href="${pageContext.request.contextPath}/teacher/topicEdit.jsp" class="btn btn-link">修改试题</a>  <a href="${pageContext.request.contextPath}/admin/TkList.jsp" class="btn btn-info">题目管理</a></div>
        ...
        <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" action="${pageContext.request.contextPath }/teacherAction?action=questionMod" method="post">
