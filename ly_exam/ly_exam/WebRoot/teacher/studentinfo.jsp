...
<html>
	...
	<body class="gray-bg">
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			...
			<div class="row">
				<a href="${pageContext.request.contextPath }/teacher/studentinfo.jsp" class="btn btn-link">学生管理</a>
				<a href="${pageContext.request.contextPath }/teacher/addStudent.jsp "class="btn btn-info">添加学生</a>
			</div>
						...
						<div class="ibox-content">
							...
							<table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td><a href="${pageContext.request.contextPath }/teacher/studentEdit.jsp"  class="btn btn-info " type="button"><i class="fa fa-paste"></i> 编辑</a>
