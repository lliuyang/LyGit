...
<html>
	...
	<body class="gray-bg">
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			...
			<div class="row">
				<a href="${pageContext.request.contextPath }/teacher/addTeacher.jsp" class="btn btn-link">教师修改</a>
				<a href="${pageContext.request.contextPath }/teacher/teacherinfo.jsp" class="btn btn-info">教师管理</a>
			</div>
