...
<html>
	...
	<body class="gray-bg">
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			...
			<div class="row">
				<a href="${pageContext.request.contextPath }/admin/studentinfo.jsp" class="btn btn-link">学生管理</a>
				<a href="${pageContext.request.contextPath }/adminAction?action=getStuClass "class="btn btn-info">添加学生</a>
			</div>
							...
							<table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <c:forEach items="${Student}"  var="stu">
 									<tr class="gradeX">
 										...
 										<td>${stu.sname}</td>
 										<td>${stu.ssex}</td>
 										<td class="center">${stu.sclass}</td>
 										<td class="center">${stu.spassword}</td>
 										<td><a href="${pageContext.request.contextPath }/adminAction?action=stuSendModify&sno=${stu.sno}"  class="btn btn-info " type="button"><i class="fa fa-paste"></i> 编辑</a>
											<a href="${pageContext.request.contextPath }/adminAction?action=stuDel&sno=${stu.sno}"><button class="btn btn-warning " type="button"><i class="fa fa-warning"></i> 
