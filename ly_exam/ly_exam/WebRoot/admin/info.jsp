...
<head>
 <base href="<%=basePath%>">    
   ...
   <link href="<%=basePath%>/admin/Reception/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="<%=basePath%>/admin/Reception/css/font-awesome.css?v=4.4.0" rel="stylesheet">
    <link href="<%=basePath%>/admin/Reception/css/animate.css" rel="stylesheet">
    <link href="<%=basePath%>/admin/Reception/css/style.css?v=4.1.0" rel="stylesheet">
...
-->
    ...
    <!-- 全局js -->
    <script src="<%=basePath%>/admin/Reception/js/jquery.min.js?v=2.1.4"></script>
    <script src="<%=basePath%>/admin/Reception/js/bootstrap.min.js?v=3.3.6"></script>



    <!-- 自定义js -->
    <script src="<%=basePath%>/admin/Reception/js/content.js?v=1.0.0"></script>
    </body>
