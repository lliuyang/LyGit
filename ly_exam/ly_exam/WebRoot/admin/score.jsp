...
<link href="${pageContext.request.contextPath}/admin/assets/css/style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/assets/js/jquery-1.8.3.min.js"></script>
</head>
<body onLoad="sendRequest()" >

<div class="videozz"></div>
	<video  autoplay muted loop poster="${pageContext.request.contextPath}/admin/assets/images/fallba1ck.jpg">
		<source src="${pageContext.request.contextPath}/admin/assets/images/mov.mp4">		
		你的游览器不支持video支持
	</video>
    ...
    <div class="m-2">
          <div class="m-2-1">
            <form action="#" method="post">
                <div class="m-2-2">
                   <input type="text" placeholder="请输入您的学号" /><br>
...
<script src="${pageContext.request.contextPath}/admin/assets/js/common.min.js"></script>
