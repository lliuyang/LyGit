...
<html>
	...
	<body class="gray-bg">
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			...
			<div class="row">
				<a href="${pageContext.request.contextPath }/admin/addTeacher.jsp" class="btn btn-link">教师添加</a>
             ...
             <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <form class="form-horizontal" action="${pageContext.request.contextPath }/adminAction?action=teacherAdd" method="post">
                        <div class="form-group">
                                <label class="col-sm-3 control-label">教师编号：</label>

                                <div class="col-sm-8">
                                    <input type="text" name="tno" placeholder="教师编号" class="form-control"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="tname" placeholder="真实姓名" class="form-control"> 
                            ...
                            <label class="col-sm-3 control-label">性别：</label>
                             <div class="col-sm-8">
                                        <label>
                                            <input type="radio" value="男" name="tsex"> <i></i>男</label>
                                   
                                        <label style="margin-left: 30px;">
                                            <input type="radio" checked="" value="女" name="tsex"> <i></i>女</label>
                                     </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="password" name="tpassword" placeholder="密码" class="form-control">
                                </div>
                            </div>
