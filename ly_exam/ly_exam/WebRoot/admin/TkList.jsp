...
<body class="gray-bg">
	 <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="row"> <a href="${pageContext.request.contextPath}/admin/TkList.jsp" class="btn btn-link">题目列表</a> <a href="${pageContext.request.contextPath}/adminAction?action=sendAddQuestion" class="btn btn-info">添加题目</a> </div>
...
<th >ID</th>
	...
	<td>  <a href="${pageContext.request.contextPath}/adminAction?action=sQuestionMod&qno=${question.qno}" class="btn btn-info " type="button"><i class="fa fa-paste"></i> 编辑</a>
		<a href="${pageContext.request.contextPath}/adminAction?action=questionDel&qno=${question.qno}"><button class="btn btn-warning " type="button"><i class="fa fa-warning"></i> <span class="bold">删除</span></button></a></td>
                                </tr>
                                </c:forEach>   
                                </tbody>
                                <tfoot>
